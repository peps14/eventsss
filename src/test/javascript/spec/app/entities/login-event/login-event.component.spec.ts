...
import { LoginEventComponent } from 'app/entities/login-event/login-event.component';
...
describe('Component Tests', () => {
  describe('LoginEvent Management Component', () => {
    let comp: LoginEventComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LoginEventComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.loginEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
